...
//
//	esp_err_t evt_loop_result = esp_event_loop_create_default();
//	ESP_LOGI(TAG, "Event loop creation result: %s", esp_err_to_name(evt_loop_result));
//
...
void wifiConnect(char* ssid, char* password) {
	ESP_LOGI(TAG, "Connecting to WiFi, SSID = %s, passwd = %s", ssid, password);
